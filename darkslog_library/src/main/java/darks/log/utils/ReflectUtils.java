...
public final class ReflectUtils {
    ...
    static final String[] DEFAULT_DIRS = new String[]{LAYOUT_CLASS_DIR,
            FILTER_CLASS_DIR, CONVERTOR_CLASS_DIR, EXTERNS_CLASS_DIR};
    ...
    public static boolean setMethodValue(Object obj, Method method,
    ...
    public static Object convertStringObject(Class<?> paramType, String val) {
        try {
            if (int.class.equals(paramType) || Integer.class.equals(paramType)) {
                ...
                Class<?> clazz = ClassFinder.findClass(val, DEFAULT_DIRS);
                if (clazz == null) {
                    throw new ConfigException("Cannot instance object class "
                            + val);
                }
    ...
    public static Method getGetMethod(Class<?> clazz, String name) {
        ...
        try {
            ...
            Kernel.logError("Fail to get " + clazz.getName() + "'s get method:"
                    + e.getMessage());
        } catch (Exception e) {
